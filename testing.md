...
In this lab you will learn how to write tests for Caravel and your user project using Cocotb. In the current state, if you run the tests using `cf verify --all` you should see that 3 tests are failing and 1 test is passing. The goal of this lab is to integrate a simple wishbone GPIO module into the user project space and implement the code for the management core, such that all the tests pass.
